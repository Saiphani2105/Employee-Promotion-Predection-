...
test = pd.read_csv(r"C:\Users\phane\Desktop\Employee-promotion-prediction-main\Assets\dataset\test (1).csv")
train = pd.read_csv(r'C:\Users\phane\Desktop\Employee-promotion-prediction-main\Assets\dataset\train (1).csv')
...
pickle.dump(model, open(r'C:\Users\phane\Desktop\Employee-promotion-prediction-main\Assets\pickle\model.pkl', 'wb'))
pickle.dump(sc, open(r'C:\Users\phane\Desktop\Employee-promotion-prediction-main\Assets\pickle\scalar.pkl', 'wb'))
